...
const ThemeSwitch: React.FC<ThemeSwitchProps> = ({ theme, toggleTheme }) => {
  ...
  return (
    <StyledWrapper>
      <label className="theme-switch" htmlFor="theme-switch-checkbox" aria-label={isChecked ? 'Switch to light theme' : 'Switch to dark theme'}>
        <input 
            type="checkbox" 
...
const StyledWrapper = styled.div`
  display: flex; /* Added to help with alignment in the header */
  align-items: center; /* Added to help with alignment in the header */
  justify-content: center; /* Added to help with alignment in the header */
  
  .theme-switch {
    --toggle-size: 18px; /* Adjusted to make the switch smaller, was 20px */
